  ...
  return (
    <div className='grid grid-cols-2 min-h-screen w-full'>
      <div className='h-full flex justify-center'>
        <div className='mt-40'>
        <h1 className='text-[40px] font-extrabold'>Welcome Back</h1>
        <p className='text-gray-500 mt-3 font-medium'>Log in to continue classifying and making a difference</p>
      <form onSubmit={handleLogin}>
        ...
        <input className='bg-green-400 rounded-md p-3 mt-4 w-full font-medium ' type="submit" value="Log in" />
      </form>
        </div>
      </div>
